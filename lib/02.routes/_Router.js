...
// Missions
AdminMissionsListController = ApplicationController.extend({
	data: function () {
		var obj = {
			'missions': Missions.find({}, { sort: { createdAt: -1 } })
		};
		return _.extend(AdminMissionsListController.__super__.data.call(this), obj);
	},
	waitOn: function () {
		return [
...
Router.route('admin/mission/list', {
	...
	controller: 'AdminMissionsListController',
});
