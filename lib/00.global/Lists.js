...
Lists.actions.values = [
	...
	{ id: 'mission-unarchive', text: "Désarchivage de mission", },
	{ id: 'mission-accept', text: "Affectation de mission", },
	{ id: 'invite-create', text: "Nouvelle invitation", },
	{ id: 'invite-accept', text: "L'invitation a été acceptée", },
];
...
Lists.missionWorkflow.ids = _.map(Lists.missionWorkflow.values, function (obj) { return obj.id; });
Lists.missionWorkflow.map = _.object(_.map(Lists.missionWorkflow.values, function (item) { return [item.code, item.id]; }));
Lists.missionWorkflow.get = function (missionId) { return _.findWhere(Lists.missionWorkflow.values, { id: missionId }); };
