...
// 	'notifyUsers': { type: String, optional: true },
// });
Lists.actions.values = [
	...
	{
		id: 'user-log-off',
		text: "Déconnexion utilisateur",
	},
	{
		id: 'user-verify-email',
		text: "Vérification d'adresse e-mail",
		title: "Un utilisateur a vérifié son adresse e-mail",
	...
	},
	{
		...
		title: "Une mission a été affectée à un indépendant sur Indie IT",
		subtitle: "Une mission vient d'être affectée à un indépendant sur Indie IT",
		route: 'mission',
		notifyCompany: true,
	},
	{
		id: 'freelance-assigned',
		title: "Affectation d'un indépendant",
		subtitle: "Affectation d'un indépendant",
		text: "Un indépendant a été choisi pour effectuer une mission",
		route: "freelance-profile",
		notifyCompany: true,
	},
	...
	{
		id: 'tos-to-accept',
		text: "Les CGU doivent être acceptées",
		notifyUsers: true,
	},
	{
		id: 'tos-accept',
		text: "Les CGU ont été acceptées"
	},
];
...
Lists.roles.dropdownValues = _.map(Lists.roles.values.splice(1, 2), (obj) => { return { value: obj.id, label: obj.text }; });

Lists.skillLevel = {};
Lists.skillLevel.values = [
	{ id: 0, text: 'Tous niveaux', description: "Tous les niveaux sont acceptés."},
	{ id: 1, text: 'Débutant', description: "" },
	{ id: 2, text: 'Intermédiaire', description: "" },
	{ id: 3, text: 'Avancé', description: "" },
	{ id: 4, text: 'Expert', description: "" },
];
Lists.skillLevel.dropdownValuesForMission = _.map(Lists.skillLevel.values, (obj) => { return { 'value': obj.id, 'label': obj.text }; });
Lists.skillLevel.dropdownValuesForSearch = _.map(Lists.skillLevel.values, (obj) => { return { 'value': obj.id, 'label': obj.text }; });
Lists.skillLevel.dropdownValuesForFreelance = _.map(Lists.skillLevel.values.splice(1), (obj) => { return { 'value': obj.id, 'label': obj.text }; });
